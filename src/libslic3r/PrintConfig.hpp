...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    // ORCA: Height-adaptive acceleration scaling (per-feature). See height_adaptive_slowdown.
    ((ConfigOptionPercent,            outer_wall_acceleration_height_scale))
    ((ConfigOptionPercent,            inner_wall_acceleration_height_scale))
    ((ConfigOptionPercent,            sparse_infill_acceleration_height_scale))
    ((ConfigOptionPercent,            internal_solid_infill_acceleration_height_scale))
    ((ConfigOptionPercent,            top_surface_acceleration_height_scale))
    ((ConfigOptionPercent,            gap_infill_acceleration_height_scale))
    ((ConfigOptionPercent,            bridge_acceleration_height_scale))
    ((ConfigOptionPercent,            support_acceleration_height_scale))
    ((ConfigOptionPercent,            support_interface_acceleration_height_scale))
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    // ORCA: Height-adaptive speed scaling (per-feature). See height_adaptive_slowdown.
    ((ConfigOptionPercent,              outer_wall_speed_height_scale))
    ((ConfigOptionPercent,              inner_wall_speed_height_scale))
    ((ConfigOptionPercent,              sparse_infill_speed_height_scale))
    ((ConfigOptionPercent,              internal_solid_infill_speed_height_scale))
    ((ConfigOptionPercent,              top_surface_speed_height_scale))
    ((ConfigOptionPercent,              gap_infill_speed_height_scale))
    ((ConfigOptionPercent,              bridge_speed_height_scale))
    ((ConfigOptionPercent,              support_speed_height_scale))
    ((ConfigOptionPercent,              support_interface_speed_height_scale))
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    // ORCA: Height-adaptive speed/acceleration scaling — slow down as the print gets taller.
