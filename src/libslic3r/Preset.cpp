...
static std::vector<std::string> s_Preset_print_options{
    ...
    "outer_wall_acceleration_height_scale", "inner_wall_acceleration_height_scale", "sparse_infill_acceleration_height_scale",
    "internal_solid_infill_acceleration_height_scale", "top_surface_acceleration_height_scale", "gap_infill_acceleration_height_scale",
    "bridge_acceleration_height_scale", "support_acceleration_height_scale", "support_interface_acceleration_height_scale", "travel_acceleration_height_scale",
