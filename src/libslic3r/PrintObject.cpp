    ...
    const ConfigOptionResolver &old_config, const ConfigOptionResolver &new_config, const std::vector<t_config_option_key> &opt_keys)
{
    ...
    for (const t_config_option_key &opt_key : opt_keys) {
        if (   opt_key == "brim_width"
            ...
            || opt_key == "shell_material_filament_id"
            || opt_key == "shell_material_thickness"
            || opt_key == "shell_material_sparse_infill_density"
            || opt_key == "shell_material_sparse_infill_pattern"
            || opt_key == "shell_material_wall_loops"
            || opt_key == "shell_material_interface_wall_loops"
            || opt_key == "shell_material_top"
            || opt_key == "shell_material_bottom"
            || opt_key == "shell_material_scope"
            || opt_key == "raft_layers"
